...
For instance, `scripts/solana_wallet_tracker.py` follows SOL transfers from one or more wallets using asynchronous RPC calls. It performs multi-hop tracing, stores results to JSON, and supports configurable depth and concurrency.
